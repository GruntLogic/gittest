...
<?php
	...
	$query=mysqli_query($con,"SELECT * FROM arrivals WHERE id= '$id'");
	
	for($i=0; $get_data=mysqli_fetch_assoc($query); $i++)
	{ ?>
	<div id="container"><div class="content">
		<form action="update_arrivals_submit.php?id=<?php echo $get_data['id']; ?>" method="post" enctype="multipart/form-data">	
			<fieldset>
				<table width="420" border="0" align="center">
					<legend>UPDATE DATA
					<tr><td>Current Image Name</td>
					<td width="229"><input type="text" name="description" value="<?php echo $get_data['description']; ?>"/></br></td></tr>
