...
if(isset($_REQUEST['submit']))
{
	...
	{
		$iname = $_REQUEST['description'];
		mysqli_query($con, "UPDATE arrivals SET description='$iname' WHERE id='$id'");
	...
	if ($_FILES)
	{
			...
			&& in_array($extension, $allowedExts))
		{
			...
			else
			{
				...
				$query = mysqli_query($con,"SELECT fileName FROM arrivals WHERE id='id'");
				...
				mysqli_query($con,"UPDATE arrivals set fileName = '$file' WHERE id='$id'");
				header("Location:adminhome.php");
	}
}
	}
